-- Ensure athletes can still read actual metrics when a session has
-- strava_activity_id set but the backing strava_activities row is missing.
-- This can happen with stale links from older data or partial migrations.
