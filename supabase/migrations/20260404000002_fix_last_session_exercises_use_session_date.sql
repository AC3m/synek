-- Use the session's actual calendar date (week_start + day_of_week offset) instead of
-- completed_at for ordering, filtering, and the displayed date. This prevents a session
-- completed early (e.g. today) from appearing as a past reference for sessions scheduled
-- before it.
