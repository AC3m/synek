  ...
  return (
    <div className={cn('flex items-center gap-2.5', className)}>
      ...
      >
        ...
        <path d="M2 22.5L4.5 14H8.5L6 22.5H2Z" fill="currentColor" fillOpacity="0.25" />
        {/* Mid stripe — rhythm and tempo */}
        <path d="M9.5 22.5L12.5 8H16.5L13.5 22.5H9.5Z" fill="currentColor" fillOpacity="0.55" />
        {/* Lead stripe — the sprint / performance peak */}
        <path d="M17 22.5L20.5 1.5H24.5L21 22.5H17Z" fill="currentColor" />
      </svg>
      {showWordmark && <span className={cn('font-black uppercase italic', s.text)}>SYNEK</span>}
    </div>
  );
}
